...
namespace LocalSpirits.Models.City
{
    public class CityByState
    {
        ...
        public StateName? AbreviateState(string stateName)
        {
            ...
            if (stateName.ToLower().Contains("jersey") || stateName.ToLower() == "nj") return StateName.NJ;
            if (stateName.ToLower().Contains("mexico") || stateName.ToLower() == "nm") return StateName.NM;
            if (stateName.ToLower().Contains("new york") || stateName.ToLower() == "ny") return StateName.NY;
            ...
            if (stateName.ToLower().Contains("island") || stateName.ToLower() == "ri") return StateName.RI;
            ...
            if (stateName.ToLower().Contains("west") || stateName.ToLower() == "wv") return StateName.WV;
